...
if (isset($_GET["inventory_id"])) {
    ...
    $sql_table_body = "SELECT * FROM tbl_inventory_production WHERE inventory_id='$inventory_id'";
    ...
    if (mysqli_num_rows($query_table_body) > 0) {
                            ...
                            <tr>
                                <td colspan="2" align="center">
                                    <a type="button" class="btn btn-primary round">
                                        Products Updated: ' . $row_table_body["products_updated"] . '
                                    </a>
                                </td>
                                <td colspan="2" align="center">
                                    <a type="button" class="btn btn-primary round">
        ...
        $html .= '<h1 align="center" style="padding: 5px"><i>Not Found with this INVENTORY ID!</i></h1>';
    }
