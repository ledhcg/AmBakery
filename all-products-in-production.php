...
<script>
        ...
        const element_add_1 = document.querySelector('.js-choices-add-category');
        const choices_add_1 = new Choices(element_add_1);

        const element_add_2 = document.querySelector('.js-choices-add-brand');
        const choices_add_2 = new Choices(element_add_2);

        const element_add_3 = document.querySelector('.js-choices-add-status');
        const choices_add_3 = new Choices(element_add_3);
